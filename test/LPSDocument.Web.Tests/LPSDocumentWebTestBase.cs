...
{
    public abstract class LPSDocumentWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LPSDocumentWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LPSDocumentWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LPSDocumentDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LPSDocumentDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LPSDocumentDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LPSDocumentDbContext, Task<T>> func)
        {
            T result;
